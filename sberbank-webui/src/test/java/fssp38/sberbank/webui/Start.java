...
public class Start {
    public static void main(String[] args) throws Exception {
        ...
        bb.setServer(server);
        bb.setContextPath("/");
        bb.setWar("sberbank-webui/src/main/webapp");
        ...
        try {
            ...
            try {
                Runtime.getRuntime().exec("/usr/bin/chromium-browser --no-proxy-server= http://localhost:8081/");
            } catch (IOException e) {
            }
