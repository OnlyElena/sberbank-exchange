...
/**
 * ПОСТАНОВЛЕНИЕ о снятии ареста на денежные средства должника,
 ...
 * Time: 2:18 PM
 */
public class PosRolAccountMoney {
    ...
    /*2 - взыскание, 1 - арест, 3 - снятие ареста, 5 - прекращение ИД - пост.об отмене пост. обращения на ДС*/
    String acttype = "5";

    /*Номер постановления о снятии ареста*/
    String actNumber;

    /*Дата постановления о снятии ареста*/
    String actDate;
